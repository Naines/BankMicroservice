package com.nainesh.cards.controller;

import com.nainesh.cards.constants.CardsConstants;
import com.nainesh.cards.dto.CardsContactInfoDto;
import com.nainesh.cards.dto.CardsDto;
import com.nainesh.cards.dto.ResponseDto;
import com.nainesh.cards.service.ICardsService;
...
public class CardsController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CardsDto> fetchCardsDetails(@RequestHeader("bank-correlation-id") String correlationId,
            @Valid @RequestParam @Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number must be 10 digits") String mobileNumber) {
        logger.debug("fetchCards method start");
        CardsDto cardsDto = iCardsService.fetchCard(mobileNumber);
        logger.debug("fetchCards method end");
